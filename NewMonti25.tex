...
\begin{table}
\begin{center}
\begin{tabular}{|p{0.06\textwidth}|p{0.62\textwidth}|}
\hline
...
\hline
 \multirow{4}{*}{DNA} & adenine (C$_5$H$_5$N$_5$), 
     ...
     & uracil (C$_4$H$_4$N$_2$O$_2$), tetrahydrofuran (C$_4$H$_8$O), \\
...
\begin{figure}[t!]
\includegraphics[width=\textwidth]{figuras/scaling85.eps}
...
\includegraphics[width=0.95\textwidth]{DNA.eps}
\end{figure}
