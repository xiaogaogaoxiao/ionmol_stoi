...
the CDW~[xxx]. The initial bound and final continuum radial wave 
...
work~\cite{miraglia2019}. We expect that these results will be useful
to estimate molecule fragmentation.
...
We can compute the center of gravity of the molecular energy levels as 
...
of the energy levels defined by the Toburen rule and the one given by
...
the $2p$ orbitals are located above the separating line.



The electrons in the molecular 
...
DNA molecules, obtained from the full molecular calculation.
