	...
	DO 100 IROUTE=1,2
      ...
      OPEN(UNIT=7, FILE="Be4_Brn_adn.dat", STATUS='unknown')
      OPEN(UNIT=8, FILE="Be4_Brn_CHn.dat", STATUS='unknown')
      OPEN(UNIT=9, FILE="Be4_Brn_NOH.dat", STATUS='unknown')
      OPEN(UNIT=10,FILE="Be4_Brn_PYR.dat", STATUS='unknown')

      OPEN(UNIT=11,FILE="Be4_Brn_adn_NV.dat", STATUS='unknown')
      OPEN(UNIT=12,FILE="Be4_Brn_CHn_NV.dat", STATUS='unknown')
      OPEN(UNIT=13,FILE="Be4_Brn_NOH_NV.dat", STATUS='unknown')
      OPEN(UNIT=14,FILE="Be4_Brn_PYR_NV.dat", STATUS='unknown')

                      ENDIF

      IF(IROUTE.EQ.2) THEN
      OPEN(UNIT=4, FILE="Be4_CDW.dat", STATUS='old')
      OPEN(UNIT=7, FILE="Be4_CDW_adn.dat", STATUS='unknown')
      OPEN(UNIT=8, FILE="Be4_CDW_CHn.dat", STATUS='unknown')
      OPEN(UNIT=9, FILE="Be4_CDW_NOH.dat", STATUS='unknown')
      OPEN(UNIT=10,FILE="Be4_CDW_PYR.dat", STATUS='unknown')
 
      OPEN(UNIT=11,FILE="Be4_CDW_adn_NV.dat", STATUS='unknown')
      OPEN(UNIT=12,FILE="Be4_CDW_CHn_NV.dat", STATUS='unknown')
      OPEN(UNIT=13,FILE="Be4_CDW_NOH_NV.dat", STATUS='unknown')
      OPEN(UNIT=14,FILE="Be4_CDW_PYR_NV.dat", STATUS='unknown')
                      ENDIF
C-----IF cdw
