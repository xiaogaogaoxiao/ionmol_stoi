	...
	DO 100 IROUTE=2,2
      ...
      IF(IROUTE.EQ.1) THEN
      OPEN(UNIT=4, FILE="AP_Brn.dat", STATUS='unknown')
      OPEN(UNIT=7, FILE="AP_Brn_adn.dat", STATUS='unknown')
      OPEN(UNIT=8, FILE="AP_Brn_CHn.dat", STATUS='unknown')
      OPEN(UNIT=9, FILE="AP_Brn_NOH.dat", STATUS='unknown')
      OPEN(UNIT=10,FILE="AP_Brn_PYR.dat", STATUS='unknown')

      OPEN(UNIT=11,FILE="AP_Brn_adn_NV.dat", STATUS='unknown')
      OPEN(UNIT=12,FILE="AP_Brn_CHn_NV.dat", STATUS='unknown')
      OPEN(UNIT=13,FILE="AP_Brn_NOH_NV.dat", STATUS='unknown')
      OPEN(UNIT=14,FILE="AP_Brn_PYR_NV.dat", STATUS='unknown')

                      ENDIF

      IF(IROUTE.EQ.2) THEN
      OPEN(UNIT=4, FILE="AP_CDW.dat", STATUS='old')
      OPEN(UNIT=7, FILE="AP_CDW_adn.dat", STATUS='unknown')
      OPEN(UNIT=8, FILE="AP_CDW_CHn.dat", STATUS='unknown')
      OPEN(UNIT=9, FILE="AP_CDW_NOH.dat", STATUS='unknown')
      OPEN(UNIT=10,FILE="AP_CDW_PYR.dat", STATUS='unknown')
 
      OPEN(UNIT=11,FILE="AP_CDW_adn_NV.dat", STATUS='unknown')
      OPEN(UNIT=12,FILE="AP_CDW_CHn_NV.dat", STATUS='unknown')
      OPEN(UNIT=13,FILE="AP_CDW_NOH_NV.dat", STATUS='unknown')
      OPEN(UNIT=14,FILE="AP_CDW_PYR_NV.dat", STATUS='unknown')
                      ENDIF
C-----IF cdw
  ...
  400 format(3x,f4.2,19x,f7.3)
    2 continue
c      read(4,*)
    1 continue


      WRITE( 7,701)   !"AP_CDW_adn.dat"
      WRITE(11,702)   !"AP_CDW_adn_nv.dat"
 
      WRITE( 8,801)   !"AP_CDW_CHn.dat"
	WRITE(12,802)   !"AP_CDW_CHn_NV.dat"


      WRITE(9 ,901)   !"AP_CDW_NOH.dat"
      WRITE(13,902)   !"AP_CDW_NOH_NV.dat"

      WRITE(10,1001)  !"AP_CDW_PYR.dat"
      WRITE(14,1002)  !"AP_CDW_PYR_NV.dat"
	!
