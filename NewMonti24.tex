...
\begin{table}
\begin{center}
\begin{tabular}{|p{0.06\textwidth}|p{0.65\textwidth}|}
\hline
...
In Figure 7, we display the relative difference of ionization cross 
sections 
\begin{equation}
e=\frac{\sigma^{\prime}-\sigma}{\sigma}\times 100
\label{120}
\end{equation}
for the four DNA basis. The difference obtained is of just very few 
