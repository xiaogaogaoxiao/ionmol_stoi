...
propose new active electron numbers, which leads to a more universal 
...
Galassi \textit{et al.} \cite{galassi2000} obtains molecular cross 
sections by combining CDW-EIS atomic ones based on the population of 
the molecular orbitals. Much more recently, L\"udde \textit{et al.} 
\cite{ludde2016,ludde2018} 
propose a combination of atomic cross sections with geometrical screening
corrections.

The objective of this article is to deal with two aspects; first, we perform 
...
To illustrate these effects, consider the impact of C$^{6+}$ impact on oxygen.
At an impact energy of 500~keV, the first Born approximation predicts
emitted electrons with mean energies of 46.7 eV and mean angles of 78\degree, 
while the CDW gives 62.5 eV and 60\degree. 
These results imply depper penetration closer to the direction of the ion.
...
sections $\sigma_M/Z^2$ by the impact of multicharged ions for adenine,
cytosine, 
...
At intermediate impact energies, the $Z^2$ rule no longer holds and other 
scalings can be considered in this region. 
In Fig.~\ref{fig:Zcaled_crossDNA_1}, we plotted the reduced ionization 
cross section $\sigma_M/Z$ as a function of the reduced ion impact energy
$E/Z$ as suggested by~\cite{janev1980,dubois2013}.
This scaling may be a good alternative to deal with highly charged
ions at intermediate energies in a coherent way.
...
\begin{figure*}[t!]
\centering
\includegraphics[width=0.8\textwidth]{figuras/Zscaling_adn1.eps}
\caption{Reduced CDW ionization cross section $\sigma_{M}/Z$ as a function 
of reduced ion impact energy $E/Z$. 
Experiments: \mbox{\Large$\circ$}~\cite{iriki2011} 
for proton impact and $\square$~\cite{rahman2016} for electron impact 
with equivelocity conversion.}
\label{fig:Zcaled_crossDNA_1}
\end{figure*} 
...
\begin{table}[t]
\begin{center}
\begin{tabular}{|p{0.07\textwidth}p{0.02\textwidth}p{0.02\textwidth}|
p{0.095\textwidth}p{0.02\textwidth}p{0.02\textwidth}|
p{0.095\textwidth}p{0.035\textwidth}p{0.02\textwidth}|}
\hline
...
We obtain similar results, even for $E=10$~MeV. An 
equivalent plot using the Toburen numbers $n_e$ of Table~\ref{nn} does not 
exhibit the straight lines obtained with the present scaling. The 
comparison with the 
...
Electron emission from methane, ammonia, monomethylamine, and dimethylamine by 0.25
to 2.0 MeV protons. 
